...
const ChatButton = styled('div')(({theme})=> `
  width: 75px;
  border: none;
  font-size: 0.9375rem;
  padding: 5px;
...
const ScreenButton = styled('div')(({theme})=> `
  width: auto;
  border: none;
  font-size: 0.9375rem;
  padding: 5px;
...
const StopButton = styled('div')(({theme})=> `
  width: 75px;
  height: 30px;
  border: none;
  font-size: 0.9375rem;
...
const CameraButton = styled('div')(({theme})=> `
  position: relative;
  width: 75px;
  border: none;
  font-size: 0.9375rem;
...
const SwitchMenu = styled('div')(({theme})=> `
  display: flex;
  position: absolute;
  width: 20px;
  top: 7px;
...
const SwitchList = styled('div')(({theme})=> `
  display: flex;
